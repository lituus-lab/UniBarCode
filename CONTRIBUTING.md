...
2. Pass the gates: `nimble testAll`, `nimble pyTest`, `nimble lint`, `nimble checkVGraph`.
...
See `ADRs/0004-unibarcode-conventions.md` and `AGENTS.md`. English comments, terse, describe what is done.
