...
- Status: Accepted
- Date: 2026-07-15
- Scope: UniBarCode and the conventions every engine started from it inherits
...
src/UniBarCode.nim         umbrella
src/UniBarCode/fibonacci.nim  hello-world (NimContracts)
...
- C symbol prefix: the library's own name in lower case (`unibarcode_`, so
...
| `UniBarCode` | `UniFoo` |
| `unibarcode` | `unifoo` |
| `libUniBarCode` | `libUniFoo` |
| `UniBarCode.h` | `UniFoo.h` |
| `lituus-unibarcode` | `lituus-unifoo` |
