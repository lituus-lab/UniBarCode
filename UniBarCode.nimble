...
# UniBarCode — reference scaffold for the lituus-lab Uni* family.
...
task docs, "API reference + book into pages/ — what CI publishes":
  ...
  exec "nim doc --index:on --outdir:pages/api --project --hints:off src/UniBarCode.nim"
...
task coverage, "LCOV + HTML coverage report for the Nim sources (needs lcov)":
  ...
  exec "lcov --capture --directory " & cache & " --base-directory ." &
       " --include \"*/src/UniBarCode/*\" --ignore-errors mismatch" &
